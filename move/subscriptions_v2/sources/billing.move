...
/// `paystreamer_v2::billing` — subscription lifecycle for PayStreamer v2.
///
...
module paystreamer_v2::billing {
    ...
    public fun create_subscription<T>(
        ...
        assert!(
            !vec_map::contains(account::subscriptions(account), &platform_id),
    ...
    fun registry_account_type_eq(a: &AccountType, b: &AccountType): bool {
        paystreamer_v2::registry::account_type_eq(a, b)
    }
}
