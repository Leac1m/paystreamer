...
/// `paystreamer_v2::payment` — the single money-moving path for v2.
///
...
module paystreamer_v2::payment {
    ...
    use paystreamer_v2::billing::{Self, can_bill, record_payment, record_failed_payment};
